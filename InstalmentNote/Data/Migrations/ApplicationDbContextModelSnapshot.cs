...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InstalmentNote.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("InstalmentNote.Data.Instalment", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    b.Property<string>("AccountNumber").HasMaxLength(100).HasColumnType("character varying(100)");
                    b.Property<string>("BankName").IsRequired().HasMaxLength(150).HasColumnType("character varying(150)");
                    b.Property<string>("ContractNumber").HasMaxLength(100).HasColumnType("character varying(100)");
                    b.Property<DateTime>("CreatedAtUtc").ValueGeneratedOnAdd().HasColumnType("timestamp with time zone").HasDefaultValueSql("NOW()");
                    b.Property<string>("Description").HasMaxLength(1000).HasColumnType("character varying(1000)");
                    b.Property<DateOnly>("FirstDueDate").HasColumnType("date");
                    b.Property<decimal>("InstalmentAmount").HasColumnType("numeric(18,2)");
                    b.Property<int>("InstalmentCount").HasColumnType("integer");
                    ...
                    b.HasKey("Id");
                    b.HasIndex("UserId", "BankName", "StartDate");
                    b.ToTable("Instalments");
                });

            modelBuilder.Entity("InstalmentNote.Data.InstalmentItem", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    b.Property<decimal>("Amount").HasColumnType("numeric(18,2)");
                    b.Property<DateTime>("CreatedAtUtc").ValueGeneratedOnAdd().HasColumnType("timestamp with time zone").HasDefaultValueSql("NOW()");
                    b.Property<int>("DueStatus").HasColumnType("integer");
                    b.Property<DateOnly>("DueDate").HasColumnType("date");
                    b.Property<int>("InstalmentId").HasColumnType("integer");
                    ...
                    b.HasKey("Id");
                    b.HasIndex("DueDate", "PaymentStatus", "DueStatus");
                    b.HasIndex("InstalmentId", "SequenceNumber").IsUnique();
                    b.ToTable("InstalmentItems");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserPasskey<string>", b =>
                {
                    b.Property<byte[]>("CredentialId").HasMaxLength(1024).HasColumnType("bytea");
                    b.Property<string>("UserId").IsRequired().HasColumnType("text");
            ...
            modelBuilder.Entity("InstalmentNote.Data.Instalment", b =>
                {
                    b.HasOne("InstalmentNote.Data.ApplicationUser", "User")
            ...
            modelBuilder.Entity("InstalmentNote.Data.InstalmentItem", b =>
                {
                    b.HasOne("InstalmentNote.Data.Instalment", "Instalment")
                        .WithMany("Items")
                        .HasForeignKey("InstalmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    b.Navigation("Instalment");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("InstalmentNote.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserPasskey<string>", b =>
                {
                    ...
                    b.OwnsOne("Microsoft.AspNetCore.Identity.IdentityPasskeyData", "Data", b1 =>
                        {
                            b1.Property<byte[]>("IdentityUserPasskeyCredentialId").HasColumnType("bytea");
                            b1.Property<byte[]>("AttestationObject").IsRequired().HasColumnType("bytea");
                            b1.Property<byte[]>("ClientDataJson").IsRequired().HasColumnType("bytea");
                            b1.Property<DateTimeOffset>("CreatedAt").HasColumnType("timestamp with time zone");
                            b1.Property<bool>("IsBackedUp").HasColumnType("boolean");
                            b1.Property<bool>("IsBackupEligible").HasColumnType("boolean");
                            b1.Property<bool>("IsUserVerified").HasColumnType("boolean");
                            b1.Property<string>("Name").HasColumnType("text");
                            b1.Property<byte[]>("PublicKey").IsRequired().HasColumnType("bytea");
                            b1.Property<long>("SignCount").HasColumnType("bigint");
                            b1.PrimitiveCollection<string>("Transports").HasColumnType("text[]");
